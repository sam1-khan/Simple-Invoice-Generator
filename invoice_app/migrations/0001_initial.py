# Generated by Django 4.2.7 on 2024-11-26 06:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_tax_percentage', models.DecimalField(decimal_places=2, default=0, max_digits=5, validators=[django.core.validators.MinValueValidator(0)])),
                ('item_tax', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=16)),
                ...
                ('after_tax', models.DecimalField(decimal_places=2, editable=False, max_digits=16)),
